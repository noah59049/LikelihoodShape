...
# linear model
# explain how to interpret the coefficients
# Instead we need f of y is the linear combination
# Or it's f inverse
# The function that we use here is the logit
class LinearLogisticScene(Scene):
    def construct(self):
