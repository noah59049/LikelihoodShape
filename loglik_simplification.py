...
class LoglikSimplificationScene(Scene):
    def construct(self):
        ...
        loglik5 = MathTex(r"l=\sum_{i=1}^{n}y_iln\hat{y}_i+ln(1-\hat{y}_i)-{y_i}ln(1-\hat{y}_i)")
        loglik6 = MathTex(r"l=\sum_{i=1}^{n}y_iln\hat{y}_i-{y_i}ln(1-\hat{y}_i)+ln(1-\hat{y}_i)")
